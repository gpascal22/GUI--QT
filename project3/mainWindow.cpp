...
: QMainWindow(parent) {
    ...
    GLobjS *globjSi = new GLobjS(this);
    dock->setWidget(globjSi);
    addDockWidget(Qt::LeftDockWidgetArea, dock);
   
    QObject::connect(slider, SIGNAL(valueChanged(int)), globjSi, SLOT(setValue(int)));
...
void mainMenu::createActions()
{
    ...
    aboutQtAct->setStatusTip(tr("Show the"));
